...
ap.add_argument("-sc", "--skip_count", type=int, default=0,
	help="No. of frames to skip")
...
#while True:
	...
	if len(detections) > 0:
		...
		if confidence > args["confidence"]:
			...
			if(j==0):
				# draw the label and bounding box on the frame for fake
				...
				# draw the label and bounding box on the frame for real
				label = "{}: {:.4f}".format(label, preds[j])
				cv2.putText(frame, label, (startX, startY - 10),
