...
ap.add_argument("-id", "--id", type=str, required=True,
	help="the frames will be saved in format: id_1.jpg, id_2.jpg")
...
ap.add_argument("-num", "--num_frames", type=int, required=True,
	help="# of frames to extract")
...
while True:
	if(saved >= args["num_frames"]): break
